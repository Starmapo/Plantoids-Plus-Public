...
class Highscore
{
	...
	public static function saveScore(song:String, score:Int = 0, ?diff:Int = 0, ?rating:Float = -1):Void
	{
		...
		if (!beatenSongs[songName])
		{
			beatenSongs.set(songName, true);
	...
	public static function hasBeatenSong(song:String):Bool
	{
		return beatenSongs[Paths.formatToSongPath(song)];
	}
