...
class DiscordClient
{
	...
	private static var _defaultID:String = "1099881299021402142";
	...
	public static function addLuaCallbacks(lua:State)
	{
		Lua_helper.add_callback(lua, "changeDiscordPresence",
			function(details:String, state:Null<String>, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, ?image:String)
			{
				changePresence(details, state, smallImageKey, hasStartTimestamp, endTimestamp, image);
			});
