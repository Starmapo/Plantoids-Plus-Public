...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		var pTip:FlxText = new FlxText(tipX, tipY + 48, 0, "NOTE: Plantoids+ normally doesn't use note skins that support RGB colors.", 16);
		pTip.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		pTip.borderSize = 2;
		add(pTip);
