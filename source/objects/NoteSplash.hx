...
class NoteSplash extends FlxSprite
{
	...
	public function setupNoteSplash(x:Float, y:Float, direction:Int = 0, ?note:Note = null)
	{
		...
		final isDefaultSplash = (PlayState.SONG == null || PlayState.SONG.splashSkin == null || PlayState.SONG.splashSkin.length < 1);

		var tempShader:RGBPalette = null;
		if (isDefaultSplash || (note == null || note.noteSplashData.useRGBShader) && (PlayState.SONG == null || !PlayState.SONG.disableNoteRGB))
		{
