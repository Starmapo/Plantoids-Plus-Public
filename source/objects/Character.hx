...
class Character extends FlxSprite
{
	...
	{
		final directories = Paths.getDirectories('characters');

		final tempArray:Array<String> = [];
		final characters:Array<String> = Mods.mergeAllTextsNamed('data/characterList.txt', Paths.getPreloadPath());
	...
	public function startPos(?gfCheck:Bool = false, ?gfX:Float, ?gfY:Float)
	{
		if (gfCheck && curCharacter.startsWith('gf')) // IF DAD IS GIRLFRIEND, HE GOES TO HER POSITION
		{
			if (gfX == null)
				gfX = PlayState.DEFAULT_GF_X;
			if (gfY == null)
				gfY = PlayState.DEFAULT_GF_Y;
