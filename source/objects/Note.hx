...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?createdFrom:Dynamic = null, ?arrowsName:String)
	{
		super();
		...
		if (noteData > -1)
		{
			texture = arrowsName != null ? arrowsName : '';
	...
	function loadNoteAnims()
	{
		if (isSustainNote)
		{
			animation.addByPrefix('purpleholdend', 'pruple end hold', 24, true); // this fixes some typo from the original note .FLA
