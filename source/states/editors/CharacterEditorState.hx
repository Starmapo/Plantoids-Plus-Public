...
class CharacterEditorState extends MusicBeatState
{
	...
	function addSettingsUI()
	{
		...
		var templateCharacter:FlxButton = new FlxButton(140, 50, "Load Template", function()
		{
			...
			for (character in characters)
			{
				...
				character.arrowsName = parsedJson.arrowsName;
	...
	function addAnimationsUI()
	{
		...
		var addUpdateButton:FlxButton = new FlxButton(70, animationIndicesInputText.y + 30, "Add/Update", function()
		{
			...
			for (i in 0...char.animationsArray.length)
			{
				if (char.animationsArray[i] != null && char.animationsArray[i].anim == lastAnim)
				{
					curAnim = i;
					break;
				}
			...
			animationDropDown.selectedLabel = animationInputText.text;
			genBoyOffsets();
	...
	function updatePresence()
	{
		...
		DiscordClient.changePresence("Character Editor", "Character: " + daAnim, leHealthIcon.getCharacter(), null, null, 'icon_editor');
		#end
	}
