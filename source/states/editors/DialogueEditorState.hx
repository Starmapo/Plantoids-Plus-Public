...
class DialogueEditorState extends MusicBeatState
{
	...
	function reloadCharacter()
	{
		...
		character.scale.set(DialogueCharacter.DEFAULT_SCALE * character.jsonFile.scale, DialogueCharacter.DEFAULT_SCALE * character.jsonFile.scale);
	...
	function reloadText(skipDialogue:Bool)
	{
		...
		DiscordClient.changePresence("Dialogue Editor", rpcText, null, null, 'icon_editor');
		#end
	}
