...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		portraitLeft.scale.scale(PlayState.daPixelZoom * 0.9);
		...
		portraitRight.scale.scale(PlayState.daPixelZoom * 0.9);
		...
		box.scale.scale(PlayState.daPixelZoom * 0.9);
		box.updateHitbox();
		add(box);
		...
		handSelect.scale.scale(PlayState.daPixelZoom * 0.9);
